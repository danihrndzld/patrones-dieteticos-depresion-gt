...
\abstract{Este estudio examina la relación entre marcadores inflamatorios, dieta y
	depresión en mujeres guatemaltecas de 30 años. Utilizando un diseño
...
\authornote{
	\addORCIDlink{Maria Andrée Neumann}{0009-0001-2531-6058}
...
\begin{document}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.8\linewidth]{freq.age.pdf}
		\caption{Frequency by Age.}
		\label{fig:Figure1}
	\end{figure}
...
\begin{figure}[H]
	...
	\vspace{1em} % Add vertical space between rows of images
...
%	\begin{table}
	%		\begin{threeparttable}
		...
		%			\begin{tabular}{@{}lrrr@{}}         \toprule
			...
			%				Categorical -- coda\tabfnm{b}   &      0  &   100\tabfnm{*}  &  196     \\
			\midrule
			%			\end{tabular}
